...
var EaseBy = /** @class */ (function () {
    function EaseBy(entity, offsetX, offsetY, duration, easingFcn) {
    ...
    EaseBy.prototype.isComplete = function () {
        return this._stopped || this._currentLerpTime >= this._lerpDuration;
    };
    EaseBy.prototype.reset = function () {
        this._initialized = false;
        this._stopped = false;
        this._currentLerpTime = 0;
    };
    EaseBy.prototype.stop = function () {
        this._motion.vel = (0, vector_1.vec)(0, 0);
        this._stopped = true;
    };
    return EaseBy;
}());
exports.EaseBy = EaseBy;
